...
<html class="x-admin-sm">
            ...
            <div class="layui-row layui-col-space15">
                <div class="layui-col-md12">
                    <div class="layui-card">
                        ...
                        <div class="layui-card-body ">
                            <div class="layui-inline layui-show-xs-block">
                                <button type="button" class="layui-btn" onclick="generate_current_payroll()">生成本期工资</button>
                            </div>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="layui-inline layui-show-xs-block">
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <div class="layui-inline layui-show-xs-block">
                                <button type="submit" lay-submit class="layui-btn">工资数据更新</button>
                            </div>
                        </div>
                        <div class="layui-card-body ">
                            <div style="text-align: center;font-size: 16px;height:40px;color:grey">
                                <p>{{$title}}</p>
                            </div>
                            <table class="layui-table layui-form">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-manage">
                                        <button class="layui-btn" onclick="xadmin.open('工资条','/wages/payroll/{{$wages->wages_id}}/payslip')">编辑</button>
                                        </td>
                                    </tr>
                                    @endforeach
    ...
    <script>
         ...
         * @return void
         */
        function generate_current_payroll()
        {
            $.ajax({
                url:  '/wages/generate_current_payroll',
                data: {
