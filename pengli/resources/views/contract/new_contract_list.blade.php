                    ...
                    <div class="layui-card">
                        <div class="layui-card-body ">
                            <form class="layui-form layui-col-space5" action="{{$contracts->path()}}">
                                ...
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" id="insurance_date_start" name="insurance_date_start" value="{{isset($requestData['insurance_date_start'])?$requestData['insurance_date_start']:''}}"  placeholder="投保开始时间" autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-inline layui-show-xs-block">
                                    <input type="text" id="insurance_date_end" name="insurance_date_end" value="{{isset($requestData['insurance_date_end'])?$requestData['insurance_date_end']:''}}"  placeholder="投保结束时间" autocomplete="off" class="layui-input">
                                </div>
                                <div class="layui-inline layui-show-xs-block">
                        ...
                        <div class="layui-card-body ">
                            <div class="layui-inline layui-show-xs-block">
                                <button type="button" class="layui-btn" onclick="xadmin.open('新增','/contract/new_contract/add','','',true)">新增</button>
                            </div>
                        </div>
                        <div class="layui-card-body ">
                            <table class="layui-table layui-form" lay-size="sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="td-status" style="color: {{$contract->policy_status_id == 3?'green':($contract->policy_status_id > 3?($contract->policy_status_id == 7?'grey':'red'):'')}};">
                                            {{$contract->policy_status_name}}
                                        </td>
                                        <td>{{$contract->insurance_date}}</td>
                                        <td>{{$contract->underwriting_date}}</td>
                                        <!-- <td class="td-status" style="color: {{$contract->policy_status_id >= 3 ?(empty($contract->receipt_date)?'red':'green'):''}};">
                                            {{$contract->policy_status_id >= 3 ?(empty($contract->receipt_date)?'待回执':'已回执'):'-'}}
                                        </td>
                                        <td class="td-status" style="color: {{$contract->policy_status_id >= 3 ?(empty($contract->return_visit_date)?'red':'green'):''}};">
                                            {{$contract->policy_status_id >= 3 ?(empty($contract->return_visit_date)?'待回访':'已回访'):'-'}}
                                        </td> -->
                                        ...
                                        <td class="td-manage">
                                            ...
                                            <button class="layui-btn" onclick="xadmin.open('编辑','/contract/new_contract/list/{{$contract->contract_id}}/edit')">编辑</button>
                                            @else
                                            -
                                            @endif
                                        </td>
